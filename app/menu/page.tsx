  ...
  return (
    <div className="bg-background">
      <section className="mx-auto w-full max-w-7xl px-6 pt-16 pb-8 lg:px-16 lg:pt-24">
        <p className="text-xs uppercase text-secondary-600">The Full Menu</p>
        <h1 className="mt-3 font-display text-display-lg text-primary-900">Slow-brewed, well-plated</h1>
        <p className="mt-4 max-w-2xl text-lg text-neutral-700">
          Every cup is brewed to order and every plate leaves a kitchen that measures in handfuls, not
          machines. Prices in ₹.
        </p>
      </section>
